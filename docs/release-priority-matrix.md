...
#### 来源标签体系
* 页面「GPS 实测」/「上传记录」与分享资产 `GPS VERIFIED` / `UPLOADED` 两层标签
* 页面 UI：中文标签，便于用户理解
* 分享资产：`GPS VERIFIED` 保留品牌 logo + 分隔线 + ✓ + 英文，深绿底 + 薄荷绿边框
* 分享资产：`UPLOADED` 保留文档 icon + 英文，深灰底 + 灰色边框
...
> 2026-06-12 方向修订：省域排名本期冻结，详见 `docs/follow-ups.md` 业务方向修订记录。
