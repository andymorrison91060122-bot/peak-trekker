...
import type { FocusEvent, MouseEvent, PointerEvent, Ref } from 'react'
...
export default function ExploreMountainCard({
  ...
  function handleCheckedInPress(event: MouseEvent<HTMLButtonElement>) {
  ...
  return (
    <div
      className="explore-card__link-wrap"
      data-explore-motion-card
    ...
    >
      ...
      {isCheckedIn ? (
        <button
          type="button"
          aria-label="已打卡"
          data-testid="explore-mountain-card-checkin"
          onClick={handleCheckedInPress}
          className="explore-card__checkin-button"
        >
          <span className="explore-card__checkin-capsule" data-testid="explore-mountain-card-checkin-capsule">
