...
test('activity field policy rejects locked numeric field aliases', async () => {
...
test('activity field policy rejects immutable trust-root fields', async () => {
...
test('activity field policy allows known editable fields', async () => {
