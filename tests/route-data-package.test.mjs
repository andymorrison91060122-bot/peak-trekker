...
test('builds the exact Stage 3 closure without promoting candidate data', () => {
  const pkg = buildRouteDataPackage()

  assert.equal(pkg.geometryImports.length, 74)
  ...
  assert.equal(pkg.summary.geometry.geo_conflicts, 0)
